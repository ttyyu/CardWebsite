...
namespace CardWebsite.Migrations
{
    ...
    [Migration("20240304185152_IdentitySecondAttempt")]
    partial class IdentitySecondAttempt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CardWebsite.Models.Collection", b =>
                {
                    ...
                    b.HasOne("CardWebsite.Models.Deck", "Deck")
                        .WithMany("Collections")
                        .HasForeignKey("DeckId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CardWebsite.Models.Grade", "Grade")
                        .WithMany("Collections")
